defmodule SymphonyElixir.AgentRunner do
  ...
  defp run_claude_turns(workspace, issue, claude_update_recipient, opts) do
    ...
    run_context =
      build_run_context(
        workspace, issue, claude_update_recipient,
        opts, issue_state_fetcher, max_turns, run_id
      )
  ...
  defp build_run_context(workspace, issue, claude_update_recipient,
         opts, issue_state_fetcher, max_turns, run_id) do
    %{
      workspace: workspace,
      issue: issue,
