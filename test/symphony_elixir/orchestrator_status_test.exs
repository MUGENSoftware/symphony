defmodule SymphonyElixir.OrchestratorStatusTest do
  ...
  test "orchestrator snapshot tracks claude thread totals and cli pid" do
    ...
    snapshot = GenServer.call(pid, :snapshot)
    assert %{running: [snapshot_entry]} = snapshot
    assert snapshot_entry.claude_cli_pid == "4242"
  ...
  test "application configures a rotating JSON file logger handler" do
  ...
  test "status dashboard humanizes full claude cli event set" do
    event_cases = [
